...
var employee2 = require ('./controllers/employee2.js');
...
var Mlogin =require('./controllers/Mlogin')

var receipt = require ('./controllers/receipt');

const { EMOJI_DOCOMO_RE } = require('emoji');
